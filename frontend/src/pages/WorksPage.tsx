...
const WorksPage = () => {
  ...
  if (isError) {
    return (
      <div className="flex items-center justify-center min-h-[calc(100vh-80px)] text-red-600">
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-5xl font-extrabold text-purple-800 mb-12 text-center">Meus Trabalhos</h1>
      ...
      {works.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {works.map((work) => (
            <Card key={work.id} className="rounded-xl shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl border-2 border-purple-100">
              <img
              ...
              <CardHeader className="p-6">
                <CardTitle className="text-2xl font-bold text-purple-800">{work.title}</CardTitle>
