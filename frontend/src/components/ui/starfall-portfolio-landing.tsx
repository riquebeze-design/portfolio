...
// --- DEFAULT DATA ---
const defaultData = {
  logo: { initials: 'AC', name: 'Antônio Cavalcanti' },
  navLinks: [ { label: 'Eu', href: '#about' }, { label: 'Projetos', href: '#projects' }, { label: 'Skills', href: '#skills' } ],
  resume: { label: 'Resume' },
  hero: { titleLine1: 'Design Gráfico &', titleLine2Gradient: 'Branding', subtitle: 'Atuo com design gráfico e branding, desenvolvendo identidades visuais sólidas, modernas e pensadas para gerar reconhecimento e conexão.', },
  ctaButtons: { primary: { label: 'Work' }, secondary: { label: 'Clque' }, },
        ...
        {!hideNavbar && ( // Renderiza a navbar condicionalmente
          <nav className="w-full px-6 py-4">
              <div className="max-w-7xl mx-auto flex justify-between items-center">
                  ...
                  <button onClick={resume.onClick} className="glass-button px-4 py-2 rounded-lg text-foreground text-sm font-medium">{resume.label}</button>
              </div>
          </nav>
        )}
        ...
        <main id="about" className="w-full min-h-screen flex flex-col items-center justify-center px-6 py-20">
            <div className="max-w-6xl mx-auto text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16">
                    ...
                    <button onClick={ctaButtons.secondary.onClick} className="glass-button min-w-[160px] text-sm font-medium text-foreground rounded-lg px-6 py-3">{ctaButtons.secondary.label}</button>
                </div>
